...
const RightSide = () => {
  return (
    <div className="flex flex-col md:flex-row gap-4">
      <div className="w-full md:w-[170px] h-44 bg-white border-none rounded-lg p-4 text-xl overflow-hidden">
      ...
      <div className="w-full md:w-[360px] h-44 bg-purple-500 border-none rounded-lg p-4 text-white text-3xl  overflow-hidden flex items-center justify-center">
